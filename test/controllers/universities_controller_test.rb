...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { ciudad: @university.ciudad, direccion: @university.direccion, nombre: @university.nombre }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { ciudad: @university.ciudad, direccion: @university.direccion, nombre: @university.nombre }
    assert_redirected_to university_path(assigns(:university))
  end
