...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { descripcion: @homework.descripcion, fecha_asignacion: @homework.fecha_asignacion, fecha_entrega: @homework.fecha_entrega, nota: @homework.nota }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { descripcion: @homework.descripcion, fecha_asignacion: @homework.fecha_asignacion, fecha_entrega: @homework.fecha_entrega, nota: @homework.nota }
    assert_redirected_to homework_path(assigns(:homework))
  end
